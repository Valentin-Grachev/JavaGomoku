 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://gomoku.vg.com/", wsdlLocation = "http://localhost:8080/Gomoku?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://gomoku.vg.com/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Gomoku?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://gomoku.vg.com/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gomoku.vg.com/", "ServerPort"), Server.class, features);
    }
